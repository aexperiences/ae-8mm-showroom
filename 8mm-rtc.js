/* mca-rtc.js — North Fork Pictures (AEHub) NATIVE video conferencing (own WebRTC, no third party)
   ------------------------------------------------------------------------
...
(function () {
  ...
  var API = (window.AE8MM_API||'https://ae-connect-api.vercel.app')+'/api/connect';
  ...
  window.EightMMMeet = ESPOAPI; window.MCAMeet = ESPOAPI; window.ESPOMeet = ESPOAPI; window.LCPMeet = ESPOAPI;
})();
